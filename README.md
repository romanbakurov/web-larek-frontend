...
- getProduct(productId: string): IProductItem | null - возвращает товар по его id
...
Все классы представления отвечают за отображение внутри контейцнера (DOM-элемент) передаваемых в них данных
